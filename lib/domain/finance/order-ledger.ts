...
// The server owns the needle cap (`MAX_SOURCE_SEARCH_LENGTH` in
// `convex/search.ts`): folded substring search has no term vocabulary, so
// there is deliberately no term-count limit here.
