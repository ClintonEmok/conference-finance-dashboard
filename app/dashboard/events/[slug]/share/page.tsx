...
import { useAttendeesForEvent, useEventBySlug } from "@/lib/convex/hooks/events"
...
export default function EventSharePage({
  ...
  const shares = useQuery(api.reportShares.listEventShares, event?._id ? { eventId: event._id } : "skip") as
    | Array<{
        _id: string
        token: string
        region: string | null
