...
} from "../../../../accommodation/filter-state"
...
export default function AccommodationWorkspacePage({
  ...
  if (!event.accommodationEnabled) {
    return (
      <div className="rounded-xl border border-destructive/20 bg-destructive/5 p-8 text-center">
        <BedDouble className="mx-auto mb-4 size-12 text-muted-foreground/50" />
        <h2 className="text-xl font-bold">Accommodation Not Enabled</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          Enable accommodation in event settings to manage room assignments.
        </p>
        <Button asChild variant="outline" className="mt-4">
