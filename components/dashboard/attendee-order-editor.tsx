    ...
    <div className="min-w-0 space-y-5">
      ...
      <section className="space-y-3 rounded-xl border border-destructive/30 bg-card/40 p-4">
        ...
        <p className="text-xs text-muted-foreground">
          {canRemove
            ? "Remove this attendee from the order. Their ticket, accommodation, room assignment, and payment-split records will be deleted and the order amount due recalculated. Existing payments stay on the order."
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              accommodation, room assignment, and payment-split records will be
              deleted and the order&apos;s amount due recalculated. Existing
